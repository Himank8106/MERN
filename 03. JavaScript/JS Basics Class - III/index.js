...
let firstName = new String("Binod");
...
console.log(firstName.includes("Bi"));
console.log(firstName.startsWith("Bi"));
console.log(firstName.endsWith("Bi"));
console.log(firstName[0]);
let anotherName = firstName.replace("Bi", "V") + "i";
...
arr.push(10);
arr.unshift(0);
arr.splice(4, 0, "Binod"); //index numberOfDeletedElements ValueInserted
...
let course = courses.find(function(course) {
    return course.NAme === "Binod";
});

console.log(course);

course = courses.find(function(course) {
    return course.NAme === "Bhai";
});

console.log(course);

course = courses.find(course => course.NAme === "Binod");
console.log(course);
