...
// Example - document.querySelector('div p');    // it will select the first p tag inside the div tag
// Example - document.querySelector('[custom-attribute]');  // it will select the first element with custom attribute
...
// event delegation - it is a technique in which we attach the event listener to the parent element and then we check if the target element is the desired element or not and then we perform the desired action
// it will only fire the event if the target element is span
